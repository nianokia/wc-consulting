      ...
      <Box id='aboutContent' sx={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: isMobile ? '0px' : '20px' }}>
        <Box id='headshotAndTitle' sx={{
          ...
          width: isMobile ? 'none' : '35%'
            ...
            <img src='../headshot.png' alt="Headshot of Gregory B Wright in front of a black background. He's a black man wearing glasses, a black blazer, a white buttondown shirt, and a paid navy and blue tie." width={isMobile ? '260px' : isMidSize ? '320px' : '410px'} />
        ...
        <Box id="biography" sx={{
          ...
          <article style={{
            ...
            marginRight: isMidSize ? '0' : '100px'
          }}>
            <Typography variant='body1' sx={{ my: 3.5, fontSize: isMobile ? '16px' : '20px' }}>
